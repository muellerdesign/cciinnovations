...
var wpAjaxUrl='https://cciinnovations.sitedistrict.com/wp-admin/admin-ajax.php';var flBuilderUrl='https://cciinnovations.sitedistrict.com/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://cciinnovations.sitedistrict.com/wp-content/plugins/bb-plugin/',wpAjaxUrl:'https://cciinnovations.sitedistrict.com/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5d8e24e101711',layout:'feed',pagination:'none',postSpacing:'60',postWidth:'300',matchHeight:{default:'0',medium:'',responsive:''},isRTL:false});});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5d8e25603b403',layout:'feed',pagination:'none',postSpacing:'60',postWidth:'300',matchHeight:{default:'0',medium:'',responsive:''},isRTL:false});});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5d8e267f8877d',layout:'feed',pagination:'none',postSpacing:'60',postWidth:'300',matchHeight:{default:'0',medium:'',responsive:''},isRTL:false});});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5d8e269ade779',layout:'feed',pagination:'none',postSpacing:'60',postWidth:'300',matchHeight:{default:'0',medium:'',responsive:''},isRTL:false});});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5d8e268a62810',layout:'feed',pagination:'none',postSpacing:'60',postWidth:'300',matchHeight:{default:'0',medium:'',responsive:''},isRTL:false});});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5d8e25ae530ce',layout:'feed',pagination:'none',postSpacing:'60',postWidth:'300',matchHeight:{default:'0',medium:'',responsive:''},isRTL:false});});})(jQuery);